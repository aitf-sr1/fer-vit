#!/usr/bin/env python3
"""
Download the FaRL pretrained checkpoint.

FaRL (Face Representation Learning) from CVPR 2022:
  https://github.com/FacePerceiver/FaRL

The checkpoint is a CLIP ViT-B/16 model pretrained on 20M face images.
It is used as the backbone in src/vit/config/farl_binary.yaml.
"""
...
if __name__ == '__main__':
    ...
    parser.add_argument('--variant', choices=['ep16', 'ep64'], default='ep16',
